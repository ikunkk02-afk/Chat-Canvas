...
public final class ModernUiTheme {
    ...
    private static void drawVanillaPanel(GuiGraphics context, int x, int y, int w, int h) {
    ...
    public static void shadow(GuiGraphics context, int x, int y, int width, int height) {
        roundedRect(context, x + 1, y + 2, width, height, 2, SHADOW);
    }

    public static void drawFixedPanel(GuiGraphics context, int x, int y,
    ...
    public static void drawFixedControl(GuiGraphics context, int x, int y,
    ...
    public static void drawFixedTab(GuiGraphics context, int x, int y,
                                    int width, int height,
                                    boolean hovered, boolean selected, boolean enabled) {
        int background = !enabled ? CONTROL_DISABLED
                : selected ? CONTROL_ACTIVE
    ...
    public static void roundedRect(GuiGraphics context, int x, int y,
    ...
    public static void border(GuiGraphics context, int x, int y,

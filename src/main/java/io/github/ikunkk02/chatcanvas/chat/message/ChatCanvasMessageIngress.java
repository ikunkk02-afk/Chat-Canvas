...
// import io.github.ikunkk02.chatcanvas.chat.notification.MentionNotificationController; // TODO port
// import io.github.ikunkk02.chatcanvas.chat.notification.MentionDebugPolicy; // TODO port
...
public final class ChatCanvasMessageIngress {
	...
	public void reportError(Component summary, Throwable throwable) {
		if (throwable != null) {
			io.github.ikunkk02.chatcanvas.ChatCanvasForge.LOGGER.error(summary.getString(), throwable);
		}
	...
	private boolean accept(UUID id, Component message, MessageContext context, long receivedAt) {
		...
		boolean debugSelfMention = false; // TODO: port MentionDebugPolicy
		...
		if (result.channel() == ChatCanvasChannel.PLAYER_CHAT) {
			// TODO: port MentionNotificationController
        // MentionNotificationController.instance().receive(result);
		}
		// TODO: port LocalChatLogService
        // LocalChatLogService.instance().record(result);
		return true;
	}

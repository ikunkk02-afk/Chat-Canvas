...
public final class MentionFlashOverlay {
	...
	public void register() {
		MinecraftForge.EVENT_BUS.addListener((RenderGuiOverlayEvent.Post event) -> render(event.getGuiGraphics()));
	}
	...
	private void render(net.minecraft.client.gui.GuiGraphics context) {
		...
		context.fill(0, 0, context.guiWidth(), context.guiHeight(), argb);
	}
}

...
public final class ChatCanvasEditorScreen extends BaseOwoScreen<FlowLayout> {
	...
	public ChatCanvasEditorScreen(@Nullable Screen parent) {
		super(net.minecraft.network.chat.Component.translatable("chat_canvas.editor.title"));
		this.parent = parent;
	}
	...
	private ScrollContainer<FlowLayout> buildToolbar() {
		...
		if (!compact) {
			bar.child(new SingleLineLabelComponent(
					net.minecraft.network.chat.Component.translatable("chat_canvas.editor.title")
							.withStyle(ChatFormatting.WHITE, ChatFormatting.BOLD),
					0xFFFFFFFF, 120, 12));
		}
		ButtonComponent playerButton = ModernUiTheme.button(
				net.minecraft.network.chat.Component.translatable("chat_canvas.editor.channel.player"),
		...
		ButtonComponent commandButton = ModernUiTheme.button(
				net.minecraft.network.chat.Component.translatable("chat_canvas.editor.channel.command"),
		...
		ButtonComponent styleButton = ModernUiTheme.button(
				net.minecraft.network.chat.Component.translatable("chat_canvas.ui_theme").append(net.minecraft.network.chat.Component.literal(": "))
						.append(net.minecraft.network.chat.Component.translatable(ModernUiTheme.currentStyle() == EditorUiStyle.CHAT_CANVAS
		...
		undoButton = ModernUiTheme.button(net.minecraft.network.chat.Component.translatable("chat_canvas.action.undo"), button -> undo());
		undoButton.sizing(Sizing.fixed(52), Sizing.fixed(22));
		redoButton = ModernUiTheme.button(net.minecraft.network.chat.Component.translatable("chat_canvas.action.redo"), button -> redo());
	...
	private void onSwitchTheme() {
		...
		if (themeButton != null) {
			themeButton.setMessage(
					net.minecraft.network.chat.Component.translatable("chat_canvas.ui_theme").append(net.minecraft.network.chat.Component.literal(": "))
							.append(net.minecraft.network.chat.Component.translatable(next == EditorUiStyle.CHAT_CANVAS
									? "chat_canvas.ui_theme.chat_canvas"
									: "chat_canvas.ui_theme.vanilla")));
		}
	}

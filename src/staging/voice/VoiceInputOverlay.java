...
public final class VoiceInputOverlay {
	...
	private void renderButton(GuiGraphics ctx, int mouseX, int mouseY) {
	...
	private void renderPrompt(GuiGraphics ctx, int mouseX, int mouseY) {
	...
	private static void button(GuiGraphics ctx, int x, int y, int width, int height,
							   String key) {
	...
	private static void draw(GuiGraphics ctx, String key, int x, int y, int color) {
		context.drawTextWithShadow(MinecraftClient.getInstance().textRenderer,

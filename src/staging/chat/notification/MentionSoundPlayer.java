...
public final class MentionSoundPlayer {
	...
	private static SoundEvent resolve(MentionSound sound) {
		return switch (sound == null ? MentionSound.EXPERIENCE_ORB : sound) {
			case EXPERIENCE_ORB -> net.minecraft.sounds.SoundEvents.EXPERIENCE_ORB_PICKUP;
			case NOTE_PLING -> net.minecraft.sounds.SoundEvents.NOTE_BLOCK_PLING.value();
			case AMETHYST -> net.minecraft.sounds.SoundEvents.AMETHYST_BLOCK_CHIME;

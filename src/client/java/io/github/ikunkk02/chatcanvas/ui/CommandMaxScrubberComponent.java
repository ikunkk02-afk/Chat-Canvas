...
public final class CommandMaxScrubberComponent extends BaseComponent implements NumericScrubber {
	...
	public boolean dragPointer(double mouseX, double mouseY, int button) {
		...
		double step = MinecraftClient.getInstance().isShiftPressed()
				? 1.0 : MinecraftClient.getInstance().isCtrlPressed() ? 20.0 : 5.0;
	...
	public boolean scroll(double amount) {
		...
		int step = MinecraftClient.getInstance().isShiftPressed()
				? 1 : MinecraftClient.getInstance().isCtrlPressed() ? 100 : 20;

...
public final class ChatCanvasClient implements ClientModInitializer {
	...
	public void onInitializeClient() {
		...
		ClientTickEvents.END_CLIENT_TICK.register(client -> {
			...
			if (client.gui.screen() instanceof net.minecraft.client.gui.screens.ChatScreen chatScreen) {
			...
			while (openEditor.consumeClick()) {
				if (!(client.gui.screen() instanceof ChatCanvasEditorScreen)) {
					client.gui.setScreen(EditorScreenFactory.create(client.gui.screen()));
				}
			}
		});
	}

...
class PlayerIdentityResolverTest {
	...
	void standardResolverUsesAuthoritativeSenderComponentAndExcludesPrefix() {
		Text sender = Component.literal("[VIP] ")
				.append(Component.literal("Steve").formatted(ChatFormatting.BOLD));
		Text message = Component.literal("<").append(sender).append(Component.literal("> hello Steve"));

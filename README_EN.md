...
Chat Canvas is a client-side chat enhancement and redesign mod for **Minecraft 1.21.10 (Fabric)**. It focuses on chat reading, chat input and interface layout, and adds Emoji, offline voice input, local chat history and reliable support for interactive server messages.
...
|---|---|---|
| Minecraft | Required | 1.21.10 |
| Java | Required | 21 or higher |
| Fabric Loader | Required | 0.19.3 or higher |
| Fabric API | Required | 0.138.4+1.21.10 or compatible |
| owo-lib | Required | 0.12.24+1.21.9 or compatible |
| Mod Menu | Optional | 16.0.1 or compatible |
...
- Fabric 1.21.10 only; no Forge or NeoForge build.

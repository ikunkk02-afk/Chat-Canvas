...
Chat Canvas 是一款针对 **Minecraft 1.21.3（Fabric）** 的纯客户端聊天增强与重设计模组，重点改善聊天阅读、聊天输入与界面布局，并加入 Emoji、离线语音输入、本地聊天记录，以及服务器交互消息的可靠支持。
...
1. 为 Minecraft 1.21.3 安装 [Fabric Loader](https://fabricmc.net/use/)
...
| Fabric API | 必需 | 0.106.1+1.21.3 或兼容版本 |
...
- 仅支持 Fabric 1.21.3，暂无 Forge / NeoForge 版本。

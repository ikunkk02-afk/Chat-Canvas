...
Chat Canvas 是一款针对 **Minecraft 1.21.1（Fabric）** 的纯客户端聊天增强与重设计模组，重点改善聊天阅读、聊天输入与界面布局，并加入 Emoji、离线语音输入、本地聊天记录，以及服务器交互消息的可靠支持。
...
| Fabric API | 必需 | 0.116.14+1.21.1 或兼容版本 |
| owo-lib | 必需 | 0.12.15.4+1.21 或兼容版本 |
...
- 仅支持 Fabric 1.21.1，暂无 Forge / NeoForge 版本。

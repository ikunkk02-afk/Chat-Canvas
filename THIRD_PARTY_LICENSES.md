...
Vosk is included in the Chat Canvas release JAR using NeoForge Jar-in-Jar. Its
...
The sherpa-onnx JVM bindings are included in the Chat Canvas release JAR using
NeoForge Jar-in-Jar. Platform-native libraries are not bundled; they are
...
- Component: `io.wispforest:owo-lib-neoforge`
- Version: 0.12.15.1-beta.6+1.21
...
- Component: `net.neoforged:neoforge`
- Version: 21.1.249
- Copyright: NeoForged contributors
- License: LGPL 2.1
- Source: https://github.com/neoforged/NeoForge

NeoForge is the required mod loader. It is not bundled in the Chat Canvas JAR.

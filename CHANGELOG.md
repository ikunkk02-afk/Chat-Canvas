...
- **Minecraft 1.21.2 Fabric port**: retained the template's 1.21.2 mappings, Fabric Loader, Fabric API, owo-lib, Loom and Gradle baseline while porting the complete 1.3.0 feature set.

...
Chat Canvas 是一款针对 **Minecraft 1.21.10（Fabric）** 的纯客户端聊天增强与重设计模组，重点改善聊天阅读、聊天输入与界面布局，并加入 Emoji、离线语音输入、本地聊天记录，以及服务器交互消息的可靠支持。
...
1. 为 Minecraft 1.21.10 安装 [Fabric Loader](https://fabricmc.net/use/)
...
| 依赖 | 类型 | 版本 |
|---|---|---|
| Minecraft | 必需 | 1.21.10 |
| Java | 必需 | 21 或更高 |
| Fabric Loader | 必需 | 0.19.3 或更高 |
| Fabric API | 必需 | 0.138.4+1.21.10 或兼容版本 |
| owo-lib | 必需 | 0.12.24+1.21.9 或兼容版本 |
| Mod Menu | 可选 | 16.0.1 或兼容版本 |
...
- 仅支持 Fabric 1.21.10，暂无 Forge / NeoForge 版本。

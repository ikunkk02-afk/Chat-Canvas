...
<p align="center">
  <img src="src/main/resources/assets/chatcanvas/icon.png" width="180" alt="Chat Canvas">
</p>

# Chat Canvas

![Minecraft](https://img.shields.io/badge/Minecraft-1.21.1-green)
![Loader](https://img.shields.io/badge/Loader-NeoForge-lightyellow)
...
Chat Canvas is a client-side chat enhancement and redesign mod for **Minecraft 1.21.1 (NeoForge)**. It focuses on chat reading, chat input and interface layout, and adds Emoji, offline voice input, local chat history and reliable support for interactive server messages.
...
2. Install [owo-lib](https://modrinth.com/mod/owo-lib) for NeoForge
...
5. The configuration screen is available from the NeoForge Mods screen
...
| NeoForge | Required | 21.1.249 or higher |
| owo-lib | Required | 0.12.15.1-beta.6+1.21 or compatible |
...
Chat Canvas is **client-side only**. It does not need to be installed on the server and works with vanilla, NeoForge, Paper or Spigot servers. It does not bypass server permissions — commands are executed by the server as usual.
...
- NeoForge 1.21.1 only; no Fabric or Forge build.
...
Press **K** in-game (or open Chat Canvas from the NeoForge Mods screen) to access the editor with eight settings tabs:
...
- [NeoForge](https://github.com/neoforged/NeoForge), [owo-lib](https://github.com/wisp-forest/owo-lib)

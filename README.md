...
Chat Canvas is a client-side chat enhancement and redesign mod for **Minecraft 1.21.3 (Fabric)**. It focuses on chat reading, chat input and interface layout, and adds Emoji, offline voice input, local chat history and reliable support for interactive server messages.
...
|---|---|---|
| Minecraft | Required | 1.21.3 |
| Java | Required | 21 or higher |
| Fabric Loader | Required | 0.19.3 or higher |
| Fabric API | Required | 0.106.1+1.21.3 or compatible |
| owo-lib | Required | 0.12.18+1.21.2 or compatible |
...
Compatibility targets (live coexistence was not exercised in this port session):
...
- Fabric 1.21.3 only; no Forge or NeoForge build.

...
Chat Canvas is a client-side chat enhancement and redesign mod for **Minecraft 1.21.2 (Fabric)**. It focuses on chat reading, chat input and interface layout, and adds Emoji, offline voice input, local chat history and reliable support for interactive server messages.
...
|---|---|---|
| Minecraft | Required | 1.21.2 |
| Java | Required | 21 or higher |
| Fabric Loader | Required | 0.16.7 or higher |
| Fabric API | Required | 0.105.4+1.21.2 or compatible |

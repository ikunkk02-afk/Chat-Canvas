...
Chat Canvas is a client-side chat enhancement and redesign mod for **Minecraft 1.21.11 (Fabric)**. It focuses on chat reading, chat input and interface layout, and adds Emoji, offline voice input, local chat history and reliable support for interactive server messages.
...
| Fabric API | Required | 0.141.6+1.21.11 or compatible |
| owo-lib | Required | 0.13.0+1.21.11 or compatible |
...
- Fabric 1.21.11 only; no Forge or NeoForge build.

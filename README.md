...
Chat Canvas 是一款针对 **Minecraft 1.21.4（Fabric）** 的纯客户端聊天增强与重设计模组，重点改善聊天阅读、聊天输入与界面布局，并加入 Emoji、离线语音输入、本地聊天记录，以及服务器交互消息的可靠支持。
...
1. 为 Minecraft 1.21.4 安装 [Fabric Loader](https://fabricmc.net/use/)
...
| Fabric API | 必需 | 0.119.4+1.21.4 或兼容版本 |
| owo-lib | 必需 | 0.12.20+1.21.4 或兼容版本 |
| Mod Menu | 可选 | 13.0.2 或兼容版本 |
...
- 仅支持 Fabric 1.21.4，暂无 Forge / NeoForge 版本。
